...
\begin{homeworkProblem}[: Poner Oracle disponible por red (2 puntos)]
...
\begin{homeworkProblem}[: Crear usuarios para tus compañeros (2 puntos)]
...
\begin{homeworkProblem}[: Dar acceso a otros usuarios a un campo de tus tablas (6 puntos)]
  Cambia la contraseña de tu usuario, para que ningún compañero pueda utilizarlo (con \texttt{ALTER USER}). Después, importa en tu usuario las tablas del fichero \enlace{https://alvarogonzalezsotillo.github.io/sistemas-gestores-bbdd-asir2/apuntes/2/sql/multas.sql}{multas.sql} (\adjuntardoc{sql/multas.sql}{adjunto aquí este \textbf{PDF}})
...
\item La entrega de las órdenes SQL utilizadas en el aula virtual (\textbf{50\%})
  ...
  \item Sube el documento a \enlace{http://aulavirtual2.educa.madrid.org/mod/assignment/view.php?id=1134799}{la tarea correspondiente en el aula virtual}
